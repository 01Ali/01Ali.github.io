...
//*MUTE SECTION
//I want to adjust the audio turn off or on the audio
//Signifier – I want to click a button 
//Accordance  – I want to toggle between mute an unmute 
//Feedback – I want to update the button to describe the current state. 



//This is my function to mute and unmute
function muteUnmute(){
